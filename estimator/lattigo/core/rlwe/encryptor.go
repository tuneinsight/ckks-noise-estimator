...
// KeyType returns a nil pointer to the type of the underlying
// encryption key wrapped as the [EncryptionKey] interface.
// Returns nil if no key was set.
func (enc Encryptor) KeyType() EncryptionKey {
